...
import com.cqut.stack.bn.entity.dto.role.ElTreeDTO;
import com.cqut.stack.bn.entity.dto.role.GetRoleDTO;
import com.cqut.stack.bn.entity.dto.role.ResultRoleDTO;
import com.cqut.stack.bn.entity.dto.role.RoleTypeDTO;
import com.cqut.stack.bn.entity.entity.Role;
...
public interface RoleManagementMapper {
     ...
     * 获取自己创建的角色
     */
    Page<ResultRoleDTO> selectRoleCreateBySelf(@Param("id") String id);
